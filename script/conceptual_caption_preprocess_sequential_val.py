...
class Conceptual_Caption(RNGDataFlow):
    ...
    def __init__(self, corpus_path, shuffle=False):
        ...
        self.name = os.path.join(corpus_path, 'CC_val_resnet101_faster_rcnn_genome.tsv.%d')
        ...
        df = open_tsv('/mnt/yangan.ya/VL-BERT/data/conceptual-captions/utils/Validation_GCC-1.1.0-Validation.tsv', 'validation')
        ...
        json.dump(self.captions, open('/mnt3/yangan.ya/features_lmdb/CC_val/caption_val.json', 'w'))
...
if __name__ == '__main__':
    ...
    corpus_path = '/mnt3/yangan.ya/features/CC_val'
    ds = Conceptual_Caption(corpus_path)

    ds1 = PrefetchDataZMQ(ds, nr_proc=1)
    LMDBSerializer.save(ds1, '/mnt3/yangan.ya/features_lmdb/CC_val/validation_all.lmdb')

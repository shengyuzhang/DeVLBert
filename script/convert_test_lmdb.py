...
name = '/mnt4/yangan.ya/features/coco_100obj/coco_test_resnet101_faster_rcnn_genome.tsv.0'
infiles = [name]

outdir = '/mnt4/yangan.ya/features_lmdb/coco_100obj'
save_path = os.path.join(outdir, 'coco_test_resnet101_faster_rcnn_genome.lmdb')

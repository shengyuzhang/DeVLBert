...
class Conceptual_Caption(RNGDataFlow):
    ...
    def __init__(self, corpus_path, shuffle=False):
        ...
        self.infiles = [os.path.join(corpus_path, 'CC_resnet101_faster_rcnn_genome.tsv.15')] # a part of training tsv features
        self.counts = []
        self.num_caps = 193987 # TODO: compute the number of processed pics
...
if __name__ == '__main__':
    corpus_path = '/mnt3/yangan.ya/features/CC_sample'
    ds = Conceptual_Caption(corpus_path)
    ds1 = PrefetchDataZMQ(ds, nr_proc=1)
    LMDBSerializer.save(ds1, '/mnt3/yangan.ya/features_lmdb/CC_sample/training_feat_all.lmdb')

...
class Conceptual_Caption(RNGDataFlow):
    ...
    def __init__(self, corpus_path, shuffle=False):
        ...
        self.counts = []
        self.num_caps = 3103920 # TODO: compute the number of processed pics
        ...
        json.dump(self.captions, open('/mnt3/yangan.ya/features_lmdb/CC/caption_train.json', 'w'))
...
if __name__ == '__main__':
    corpus_path = '/mnt3/yangan.ya/features/CC'

...
class ConceptCapLoaderTrain(object):
    ...
    def __init__(
        ...
        if dist.is_available() and distributed:
            ...
            # if not os.path.exists(lmdb_file):
            lmdb_file = "/mnt3/xuesheng/features_lmdb/CC/training_feat_all.lmdb"
    ...
    def __iter__(self):
        ...
        for batch in self.ds.get_data():
            ...
            image_loc, image_target, image_label, image_mask, image_id, image_feature_og, num_boxes = batch
            ...
            # image_loc, image_target, image_label, image_mask, image_id, image_feature_og)
            batch = (input_ids, image_feat, image_loc, segment_ids, input_mask, image_mask, image_target, num_boxes)
